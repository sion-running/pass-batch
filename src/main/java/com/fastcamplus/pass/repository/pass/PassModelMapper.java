package com.fastcamplus.pass.repository.pass;
...
public interface PassModelMapper {
    ...
    // BulkPassStatus와 관계 없이 PassStatus 값을 설정
    @Named("defaultStatus")

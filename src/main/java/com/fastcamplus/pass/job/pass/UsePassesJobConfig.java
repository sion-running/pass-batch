...
import com.fastcamplus.pass.repository.booking.BookingRepository;
import com.fastcamplus.pass.repository.booking.BookingStatus;
...
public class UsePassesJobConfig {
    ...
    @Bean
    public AsyncItemProcessor<BookingEntity, BookingEntity> usePassesAsyncItemProcessor() { // async item processor
    ...
    @Bean
    public ItemProcessor<BookingEntity, BookingEntity> usePassesItemProcessor() { // 일반적인 item processor
